...
function ktn_admin_notices() {
	...
	if ( empty( $token ) ) {
		...
		<div class="notice notice-warning is-dismissible">
			<p><?php printf( __( '<strong>Cinema Guide Importer:</strong> TMDB Bearer Token is not configured. Please <a href="%s">configure your settings</a>.', 'kontentainment' ), esc_url( $settings_url ) ); ?></p>
		</div>
		<?php
	}
}
